...
def user_input_features():
  ...
  Age = left.st.slider('อายุเท่าไหร่',0,100,22)
  left.st.write('อายุ', Age,'ปี')
  st.sidebar.write(' # --------------------------------------')
  
  Weight= left.st.slider('น้ำหนัก (Kg)เท่าไหร่',0,150,79)
  left.st.write('น้ำหนัก', Weight, 'กิโลกรัม')
  left.st.write(' # --------------------------------------')
  
  Cycle = st.sidebar.slider('ประจำเดือนมากี่วัน',0,31,7)
  left.st.write('รอบเดือนมา', Cycle, 'วัน')
  left.st.write(' # --------------------------------------')
  
  CycleLength= st.sidebar.slider('ระยะห่างของรอบเดือน ห่างกันกี่วัน',0,60,16)
  left.st.write('ระยะห่างของรอบเดือน', CycleLength, 'วัน')
  left.st.write(' # --------------------------------------')
  left.st.write('### สอบถามอาการ ใช่(1)หรือไม่(0) ')
